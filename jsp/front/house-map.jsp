...
<html>
    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            var point = new BMap.Point(${longitude}, ${latitude});//获取后台传过来的经纬度
            var marker = new BMap.Marker(point); // 创建标注
            map.addOverlay(marker); // 将标注添加到地图中
            var sContent =
                "<div style='padding:2px;'><span style='font-size:12px;font-weight:bold;'>${address}</span></div>"
            +"<div style='padding:2px;'><span style='font-size:12px;font-weight:bold;'>联系人：${name}</span></div>"
            +"<div style='padding:2px;'><span style='font-size:12px;font-weight:bold;'>联系电话：${phone}</span></div>";
